...
static int	ft_mouse_to_sp(t_scene *s, t_maps *ptr, t_ray *r, int do_move)
{
	double	t;
	t_vect	solution;
...
static int	ft_mouse_to_pl(t_scene *s, t_maps *ptr, t_ray *r, int do_move)
{
	double	t;
	t_vect	solution;
...
static int	ft_mouse_to_cy(t_scene *s, t_maps *ptr, t_ray *r, int do_move)
{
	double	t;
	t_vect	solution;
