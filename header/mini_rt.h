...
/*   Updated: 2025/03/06 13:26:46 by aelison          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_free_primary(t_scene *scene);
...
void			ft_sp_event(t_scene *data, t_maps *curr, int keycode,
					double incr);
int				ft_intersec_cy(t_cy *obj, t_ray *r, double *t);
...
int				check_pl(t_scene *s, t_pl *obj, t_ray *shadow_ray);
int				check_cy(t_scene *s, t_cy *obj, t_ray *shadow_ray);
int				check_sp(t_scene *s, t_sp *obj, t_ray *shadow_ray);
void			ft_scale_color(int *color_base, int keycode, int incr);
int				cmp_dist(t_scene *s, t_maps *obj, double distance);
t_vect			compute_intersec_pts(t_ray *r, double t);
int				ft_is_a_shadow(t_scene *s, t_maps *target, t_ray *origin);
